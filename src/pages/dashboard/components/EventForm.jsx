...
const EventForm = ({ handleCloseEvent, eventData, setEventData, calenderCredentialsDetails }) => {
  ...
  const validate = () => {
    ...
    if (!formData.summary) validationErrors.summary = "Summary is required.";
    ...
    if (!formData.startDateTime) validationErrors.startDateTime = "Start Date & Time is required.";
    if (!formData.endDateTime) validationErrors.endDateTime = "End Date & Time is required.";
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      // Submit form or call an API here
    } else {
